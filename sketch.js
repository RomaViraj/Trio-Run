...
function setup() {
	...
	helpScreen.addImage("hello",helpm);
	...
	helpScreen2.addImage("helpS2m", help2m);
...
function draw() {
	...
	if (level === 1) {
		...
		if (platform === "mobile") {
			helpScreen.changeImage("hello",helpm);
			helpScreen2.changeImage("helpS2m", help2m);
		}
		...
		if (gamestate === 0) {
			...
			if (platform === "mobile") {
				...
				if (touches.length > 0 && mouseY>900 / 3 && mouseY<1050 / 3 && mouseX<=1300/3) {
					gamestate = 1
					sound.loop();
					sound.setVolume(0.3)
					sound2.stop();
				...
				if (touches.length > 0 && mouseY>1050 / 3 && mouseY<1150 / 3 && mouseX<=1300/3) {
					gamestate = 4
					click.play();
					touches = [];
				}
		...
		if (gamestate === 2) {
			...
			if (platform === "mobile") {
				...
				if (touches.length > 0 && mouseX > 1024/3 && mouseY <= 1100/3) {
					gamestate = 0;
		...
		if (gamestate === 3) {
			...
			if (platform === "mobile") {
				...
				if (touches.length > 0 && mouseY>1400/3) {
					gamestate = 0
					sound2.loop();
					sound2.setVolume(0.3);
					score = 0;
